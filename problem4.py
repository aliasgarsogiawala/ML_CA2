...
# Decision Hesitation During Flight
# FINAL FIXED VERSION
# -------------------------------------------------
...
plt.title("Distribution of Decision Hesitation Levels")
plt.xlabel("Decision Hesitation")
plt.ylabel("Count")
...
plt.title("Actual vs Predicted Decision Hesitation")
plt.xlabel("Actual Decision Hesitation")
plt.ylabel("Count")
